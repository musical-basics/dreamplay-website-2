                ...
                <section className="border-t border-white/10 bg-[#050505] py-24 text-center">
                    <div className="container mx-auto max-w-3xl px-6">
                        <AnimatedSection>
                            ...
                            <Link href="https://shop.dreamplaypianos.com/" className="group inline-flex items-center justify-center gap-3 border border-white bg-white px-8 py-4 font-sans text-xs font-bold uppercase tracking-widest text-black transition-all hover:bg-neutral-200">
                                Reserve Now
